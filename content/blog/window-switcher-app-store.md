...
## Apps vs windows
There’s an important distinction between switching windows and switching apps on the Mac. As opposed to Microsoft Windows where you just `Alt-Tab` through .. well, **windows**, on macOS you `Command Tab` through **apps** by default. When an app with multiple windows is focused, `Command backtick` will cycle through the windows of that app. *the backtick character is \`*
...
Six years ago I was a Windows power user, and when I got my first Mac, Command Tabbing through apps felt very weird. Suddenly I was closing all windows of **![sublime text icon](/images/icons/sublime.webp)Sublime** but its icon was still there in the Command Tab list, or I would minimize **![chrome icon](/images/icons/chrome.svg)Chrome** and focusing its icon didn’t unminimize it. The app vs window distinction just didn’t exist in my mind. 
...
That’s the main reason I created **![rcmd icon](/images/icons/rcmd.svg)[rcmd](https://lowtechguys.com/rcmd)**, to switch apps without thinking about switching apps.
...
And if I forgot that **![Xcode icon](/images/blog/window-switcher-app-store/xcode.webp)Xcode** is not already running *(or if it crashes in the background like it sometimes does)*, rcmd launches it automatically *(since I clearly wanted it running if I tried to focus it)*.
...
- `O` for ![soulver app icon](/images/icons/soulver.webp)S**o**ulver
- `P` for ![spotify app icon](/images/icons/spotify.svg)S**p**otify
- `E` for ![sketch app icon](/images/icons/sketch.webp)Sk**e**tch *(because `K` is taken by the ![kitty app icon](/images/icons/kitty.webp)Kitty terminal)*
- `B` for ![safari app icon](/images/icons/safari.webp)Safari **b**rowser 
...
- ![kitty app icon](/images/icons/kitty.webp) check a long running task in the terminal
- ![mail app icon](/images/icons/mail.webp) check if I got an email I’m waiting for while notifications are paused
- ![spotify app icon](/images/icons/spotify.svg) see what’s this dope song that started playing from my Discover Weekly playlist

That’s why I added the **Hide** action in rcmd. 

Now I just hold `Right Command` and press `K` to check the **![kitty app icon](/images/icons/kitty.webp)[Kitty](https://sw.kovidgoyal.net/kitty/)** terminal, then, without lifting any finger, press `K` again to hide it and get back to what I was doing. 
...
- ![sublime text icon](/images/icons/sublime.webp) Separate projects/folders open in Sublime Text
- ![pages icon](/images/icons/pages.webp) Multiple documents in Pages or Microsoft Word
- ![preview icon](/images/icons/preview.webp) Lots of PDFs open for referencing in Preview
...
It’s a sunny day in Brașov, I’m on my balcony taking in the sun, testing and perfecting [XDR Brightness](https://lunar.fyi/#xdr) to make working in direct sunlight easier on my MacBook 14” while also rewriting parts of the **![Lunar Icon](/images/icons/lunar.svg)[Lunar](https://lunar.fyi)** UI in SwiftUI. 
...
I remembered **![hammerspoon icon](/images/icons/hammerspoon.webp)[Hammerspoon](https://www.hammerspoon.org)** having [a really complete window management support](https://www.hammerspoon.org/docs/hs.window.html) and it also being scriptable with Lua made it the perfect choice. 
