...
aboutme: |-
  ...
  * Carving ☕ coffee cups and 🥄 spoons out of reclaimed wood for my **[🪵 web shop](https://gospodaria.com)**
  ...
  * Wood carving using hand tools like the TWCA Cam and sloyd knives
  * Reverse engineering macOS apps and frameworks
  * Playing the Romanian kaval (shepherd's flute)

  # Find me at
  * ![Github Icon](/images/icons/github_16@2x.webp#x16) [Github](https://github.com/alin23)
  * ![Instagram Icon](/images/icons/logo-instagram.png) [Instagram](https://www.instagram.com/alin.panaitiu)
  * 🪵 [Gospodăria lui Alin](https://gospodaria.com)
  ...
  - name: Clop
    links:
      ...
      - url: https://github.com/FuzzyIdeas/Clop
        domain: github.com
    description: |-
      Clop is a macOS app that can watch your clipboard and optimise any image you copy to it so that it is as small as possible and ready to paste into a chat, website, or email.

      It can also watch folders for new images, videos or PDFs and optimise them automatically.

      There's also a handy drop zone where you can drag and drop files for quick optimisation.
    image: clop-screenshot.png
  - name: Lunar
    links:
      - url: https://lunar.fyi
        domain: lunar.fyi
